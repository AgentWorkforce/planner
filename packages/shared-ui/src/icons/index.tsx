...
function createIcon(
  ...
  const Icon: React.FC<IconProps> = ({ size, width, height, ...props }) => (
    <svg
      {...defaultProps}
...
export const GearIcon = SettingsIcon; // Alias
...
export const SpinnerIcon: React.FC<IconProps> = ({ size, className, ...props }) => (
  <svg
    width={size ?? 16}
    height={size ?? 16}
    viewBox="0 0 24 24"
